<div class="max-w-[480px] mx-auto bg-white min-h-screen relative shadow-lg pb-[70px]">
        ...
        <div class="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[480px] bg-white border-t border-gray-100 p-4 z-50">
            ...
            <a href="{{ route('product.custom-menu', $product->slug) }}" class="flex-1 h-12 flex items-center justify-center rounded-full bg-blue-600 text-white font-medium hover:bg-blue-700 transition-colors text-center">
                Pilih Custom Menu
            </a>
