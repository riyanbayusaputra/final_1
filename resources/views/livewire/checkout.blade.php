<div class="max-w-[480px] mx-auto bg-white min-h-screen relative shadow-lg pb-[140px]">
  ...
  <div class="pt-20 pb-12 px-4 space-y-8">
    ...
    <div>
      ...
      <!-- Provinsi -->
      <div>
        <label for="provinsi" class="block text-sm text-gray-600 mb-1.5">Provinsi</label>
        <select id="provinsi" wire:model.live="selected_provinsi"
          class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:ring-2 focus:ring-primary focus:border-primary bg-white">
      ...
      <!-- Kabupaten/Kota -->
      <div>
        <label for="kabupaten" class="block text-sm text-gray-600 mb-1.5">Kabupaten/Kota</label>
      ...
      <div>
        <label for="kecamatan" class="block text-sm text-gray-600 mb-1.5">Kecamatan</label>
    ...
    <div class="bg-white rounded-xl border border-gray-100 p-4 space-y-4">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input type="time" wire:model.defer="shippingData.delivery_time"
        ...
        @if ($isCustomCatering)
        <div class="mt-4">
          <label for="menu_description">Deskripsikan menu yg anda inginkan</label>
          <textarea id="menu_description" wire:model.defer="customCatering.menu_description"
                    class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:ring-2 focus:ring-primary focus:border-primary"
                    rows="3"
