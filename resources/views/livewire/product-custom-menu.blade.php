    ...
    @else
        ...
        <div class="mb-12">
            ...
            <div class="flex gap-4 overflow-x-auto pb-4 scrollbar-thin px-1">
                ...
                <label class="min-w-[140px] bg-white border-2 border-gray-200 peer-checked:border-blue-500 peer-checked:ring-2 peer-checked:ring-blue-100 rounded-2xl p-5 flex flex-col items-center text-center cursor-pointer hover:border-blue-300 hover:shadow-xl transition-all duration-300 shadow-md relative group">
                    <input
                        type="radio"
                    ...
                    <!-- Ceklist -->
                    <div class="absolute -top-1.5 -right-1.5 w-6 h-6 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 border-2 border-white flex items-center justify-center opacity-0 peer-checked:opacity-100 peer-checked:scale-110 shadow-lg z-20">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-purple-500/5 rounded-2xl opacity-0 peer-checked:opacity-100"></div>
                </label>
                @endforeach
            </div>
        </div>
